...
# Creacion del Pipeline con el scaler y definicion del mejor modelo LASSO luego de la optimizacion de hiperparametros
...
# Se guarda el modelo
import pickle
filename = '/workspace/Regularized-Lineal-Regression/models/finalized_model.sav'
